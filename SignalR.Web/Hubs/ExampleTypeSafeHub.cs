...
public class ExampleTypeSafeHub : Hub<IExampleTypeSafeHub>
{
    ...
    public async Task AddGroup(string groupName)
    {
        ...
        await Clients.Group(groupName).ReceiveMessageForGroupClient($"This user { Context.ConnectionId } added to group { groupName }");
    }
    ...
    public async Task RemoveGroup(string groupName)
    {
        ...
        await Clients.Group(groupName).ReceiveMessageForGroupClient($"This user { Context.ConnectionId } removed from group { groupName }");
    }
